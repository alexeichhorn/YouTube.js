...
export type InnerTubeClient = 'IOS' | 'IOS_DOWNGRADED' | 'WEB' | 'MWEB' | 'ANDROID' | 'ANDROID_VR' | 'ANDROID_SDKLESS' | 'YTMUSIC' | 'YTMUSIC_ANDROID' | 'YTSTUDIO_ANDROID' | 'TV' | 'TV_SIMPLY' |'TV_EMBEDDED' | 'YTKIDS' | 'WEB_EMBEDDED' | 'WEB_CREATOR';
